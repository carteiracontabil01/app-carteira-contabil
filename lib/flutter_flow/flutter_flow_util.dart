...
extension ColorOpacityExt on Color {
  ...
  // Backport of the `Color.withValues` API introduced in newer Flutter versions.
  // Only the `alpha` parameter is used in this project, so we replicate that
  // behavior here to keep the codebase compatible with older SDKs.
