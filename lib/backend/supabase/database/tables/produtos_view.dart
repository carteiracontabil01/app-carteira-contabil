...
class ProdutosViewTable extends SupabaseTable<ProdutosViewRow> {
  @override
  String get tableName => 'produtos_view';

  @override
  ProdutosViewRow createRow(Map<String, dynamic> data) => ProdutosViewRow(data);
}

class ProdutosViewRow extends SupabaseDataRow {
  ProdutosViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ProdutosViewTable();
  ...
  String? get alldate => getField<String>('alldate');
  set alldate(String? value) => setField<String>('alldate', value);
}
